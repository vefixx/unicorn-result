-- Рейтинг квартир по потреблению воды


CREATE VIEW IF NOT EXISTS stat_02_weekly_water_top AS
SELECT
    ...
    v.apartment_id,
    v.apartment_no,
    SUM(v.value_sum) AS total_m3_week,
    COUNT(v.day_ts) AS days_recorded
FROM view_resource_consumption_daily v
WHERE v.code IN ('water_cold_m3_total', 'water_hot_m3_total')
